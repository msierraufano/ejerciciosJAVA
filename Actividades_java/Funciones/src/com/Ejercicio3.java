...
public class Ejercicio3 {
	public static void main(String[] args) {
		...
		int opcion_;
		System.out.println("Dime qué quieres calcular (1) Area o (2) Volumen");
	...
	public static void cilindro(double radio , double altura, int opcion) {
		switch (opcion) {
		case 1: double area = 2 * Math.PI * radio * (altura + radio);
		System.out.println("El área es : " + area);
		break;
		case 2:double volumen = Math.PI * Math.pow(radio, 2)* altura;
